...
export function Button({
  ...
  const variants = {
    ...
    secondary: "bg-[#65a30d] text-white shadow-md hover:bg-[#5a940c] active:scale-[0.98]",
    outline:
      "bg-transparent text-[#84cc16] border border-[#84cc16]/40 hover:bg-[var(--muted)] active:scale-[0.98]",
    ghost: "bg-transparent text-[#84cc16] hover:bg-[var(--muted)] shadow-none",
    danger: "bg-[#65a30d] text-white shadow-md hover:bg-[#5a940c] active:scale-[0.98]",
  }
